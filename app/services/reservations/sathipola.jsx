...
const validationSchema = Yup.object().shape({
  ...
  sathipola: Yup.string().required('Sathipola selection is required'),
  agree: Yup.boolean().oneOf([true], 'You must agree to the terms and conditions'),
});

const SathipolaReservation = () => {
        ...
        >
          {({
            ...
            <View style={styles.form}>
              ...
              {/* Playground Picker */}
              <Picker
                selectedValue={values.sathipola}
                style={styles.picker}
                onValueChange={(itemValue) => setFieldValue('sathipola', itemValue)}
              >
                <Picker.Item label="Select Sathipola" value="" />
                <Picker.Item label="Sathipola A" value="Sathipola A" />
                <Picker.Item label="Sathipola B" value="Sathipola B" />
                <Picker.Item label="Sathipola C" value="Sathipola C" />
              </Picker>
              {touched.playground && errors.sathipola && (
                <Text style={styles.error}>{errors.sathipola}</Text>
              )}
...
export default SathipolaReservation;