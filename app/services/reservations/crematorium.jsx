  ...
  const handlePaymentSuccess = async (values) => {
    try {
      ...
      const payload = {
        ...
        funeralDate: formatDate(values.funeralDate),
        payment: totalPayment,
        // reservationDate, createdAt, and updatedAt will be handled by the backend
      };
      ...
      router.replace('/services'); // Redirect to services screen
    } catch (error) {
